...
if __name__ == '__main__':
    ...
    if args.evaluate:
        all_pulls, all_rewards, all_actions, all_positions, all_coops, all_embeds = runner.evaluate()
        ...
        print('here')
        if not (args.embed_test is None):
            with open(args.save_dir + '/' + args.scenario_name + "/all_embeds.pkl", "wb") as f:
